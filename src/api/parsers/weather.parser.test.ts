...
it("parses an api response correctly", () => {
  ...
  expect(parseResult.weatherParameters.maxTemperature).toBe(
    apiJson.main.temp_max
  );
  expect(parseResult.weatherParameters.minTemperature).toBe(
    apiJson.main.temp_min
  );
  expect(parseResult.weatherParameters.pressureAtSeaLevel).toBe(
    apiJson.main.sea_level
  );
  expect(parseResult.weatherParameters.pressureAtGroundLevel).toBe(
    apiJson.main.grnd_level
  );
