        ...
        <>
            { !!weather &&
              (<>
                  ...
                  <Row>
                      <TextLabel>
                          { `Feels like: ${Math.round(weather.weatherParameters.feelsLike)} ºC` }
                      </TextLabel>
                  </Row>
                  <Row>
                      <WeatherIconLabel
                  ...
                  <Row>
                      <WeatherIconLabel
                          name="WiCloudy"
                          text={weather.weatherParameters.cloudiness}
                          unit="%"
                      />
                      {weather.weatherParameters.rainInLastHour && <WeatherIconLabel
                          name="WiRaindrops"
                          text={weather.weatherParameters.rainInLastHour}
                          unit="h"
                      />}
                      {weather.weatherParameters.snowInLastHour && <WeatherIconLabel
                          name="WiSnow"
